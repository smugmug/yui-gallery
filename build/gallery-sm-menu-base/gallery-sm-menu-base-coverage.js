...
_yuitest_coverline("build/gallery-sm-menu-base/gallery-sm-menu-base.js", 28);
...
**/
_yuitest_coverline("build/gallery-sm-menu-base/gallery-sm-menu-base.js", 37);
...
**/
_yuitest_coverline("build/gallery-sm-menu-base/gallery-sm-menu-base.js", 46);
var EVT_HIDE = 'hide';
...
**/
_yuitest_coverline("build/gallery-sm-menu-base/gallery-sm-menu-base.js", 55);
var EVT_SHOW = 'show';
...
var MenuBase = Y.Base.create('menuBase', Y.Tree, [], {
    ...
    initializer: function (config) {
        _yuitest_coverfunc("build/gallery-sm-menu-base/gallery-sm-menu-base.js", "initializer", 61);
_yuitest_coverline("build/gallery-sm-menu-base/gallery-sm-menu-base.js", 62);
config || (config = {});
