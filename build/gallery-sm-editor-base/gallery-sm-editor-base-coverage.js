...
return this._insertHTML(doc.createTextNode(text));
    ...
    **/
    _queryCommandValue: function (name) {
        _yuitest_coverfunc("build/gallery-sm-editor-base/gallery-sm-editor-base.js", "_queryCommandValue", 502);
...
return doc.queryCommandSupported(name) ? doc.queryCommandValue(name) : null;
    ...
    **/
    _setHTML: function (value) {
        _yuitest_coverfunc("build/gallery-sm-editor-base/gallery-sm-editor-base.js", "_setHTML", 514);
...
return value;
    ...
    **/
    _setText: function (value) {
        _yuitest_coverfunc("build/gallery-sm-editor-base/gallery-sm-editor-base.js", "_setText", 530);
_yuitest_coverline("build/gallery-sm-editor-base/gallery-sm-editor-base.js", 531);
if (this._rendered) {
...
return value;
    ...
    **/
    _updateSelection:  function (options) {
        _yuitest_coverfunc("build/gallery-sm-editor-base/gallery-sm-editor-base.js", "_updateSelection", 551);
...
this.fire(EVT_SELECTION_CHANGE, {
    ...
    **/
    _onBlur: function () {
        _yuitest_coverfunc("build/gallery-sm-editor-base/gallery-sm-editor-base.js", "_onBlur", 589);
...
this.fire(EVT_BLUR);
    ...
    **/
    _onCopy: function (e) {
        _yuitest_coverfunc("build/gallery-sm-editor-base/gallery-sm-editor-base.js", "_onCopy", 606);
...
try {
            ...
            _yuitest_coverline("build/gallery-sm-editor-base/gallery-sm-editor-base.js", 615);
...
clipboard.setData('text', contents);
    ...
    **/
    _onCut: function (e) {
        _yuitest_coverfunc("build/gallery-sm-editor-base/gallery-sm-editor-base.js", "_onCut", 629);
...
e.preventDefault();
        ...
        _yuitest_coverline("build/gallery-sm-editor-base/gallery-sm-editor-base.js", 641);
...
clipboard.setData('text', contents);
    ...
    **/
    _onDblClick: function() {
        _yuitest_coverfunc("build/gallery-sm-editor-base/gallery-sm-editor-base.js", "_onDblClick", 658);
...
this.selection.select(range.shrink({trim: true}));
    ...
    **/
    _onFocus: function () {
        _yuitest_coverfunc("build/gallery-sm-editor-base/gallery-sm-editor-base.js", "_onFocus", 670);
...
range.selectNodeContents(node);
            _yuitest_coverline("build/gallery-sm-editor-base/gallery-sm-editor-base.js", 685);
...
selection.select(range);
        ...
        _yuitest_coverline("build/gallery-sm-editor-base/gallery-sm-editor-base.js", 690);
this._updateSelection();

        _yuitest_coverline("build/gallery-sm-editor-base/gallery-sm-editor-base.js", 692);
clearInterval(this._selectionMonitor);

        _yuitest_coverline("build/gallery-sm-editor-base/gallery-sm-editor-base.js", 694);
this._selectionMonitor = setInterval(function () {
            _yuitest_coverfunc("build/gallery-sm-editor-base/gallery-sm-editor-base.js", "(anonymous 4)", 694);
_yuitest_coverline("build/gallery-sm-editor-base/gallery-sm-editor-base.js", 695);
self._updateSelection();
        }, 200);

        _yuitest_coverline("build/gallery-sm-editor-base/gallery-sm-editor-base.js", 698);
this.fire(EVT_FOCUS);
    },
    ...
    **/
    _onPaste: function (e) {
        _yuitest_coverfunc("build/gallery-sm-editor-base/gallery-sm-editor-base.js", "_onPaste", 708);
_yuitest_coverline("build/gallery-sm-editor-base/gallery-sm-editor-base.js", 709);
var clipboard = e._event.clipboardData || win.clipboardData,
            contents = clipboard.getData('text');

        _yuitest_coverline("build/gallery-sm-editor-base/gallery-sm-editor-base.js", 712);
e.preventDefault();

        // create a document-fragment with the pasted contents
        // then get the text content of the fragment. effectively
        // strips tags.
        _yuitest_coverline("build/gallery-sm-editor-base/gallery-sm-editor-base.js", 717);
contents = Y.Node.create(contents).get('text');

        _yuitest_coverline("build/gallery-sm-editor-base/gallery-sm-editor-base.js", 719);
...
_yuitest_coverline("build/gallery-sm-editor-base/gallery-sm-editor-base.js", 767);
