...
return this;
    ...
    **/
    toggle: function (options) {
        _yuitest_coverfunc("build/gallery-sm-menu/gallery-sm-menu.js", "toggle", 477);
...
this.get('container').toggleClass(this.classNames.open, e.newVal);
    ...
    **/
    _onItemClick: function (e) {
        _yuitest_coverfunc("build/gallery-sm-menu/gallery-sm-menu.js", "_onItemClick", 1005);
...
if (!this._published[EVT_ITEM_CLICK]) {
            _yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1027);
this._published[EVT_ITEM_CLICK] = this.publish(EVT_ITEM_CLICK, {
                defaultFn: this._defItemClickFn
            });
        }

        _yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1032);
this.fire(eventName, {
            originEvent: e,
            item       : item
        });
    ...
    **/
    _onItemMouseEnter: function (e) {
        _yuitest_coverfunc("build/gallery-sm-menu/gallery-sm-menu.js", "_onItemMouseEnter", 1045);
_yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1046);
var item = this.getNodeById(e.currentTarget.get('id'));

        _yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1048);
clearTimeout(this._timeouts.item);

        _yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1050);
if (item.isOpen() || item.isDisabled()) {
            _yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1051);
return;
        }

        _yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1054);
this._timeouts.item = setTimeout(function () {
            _yuitest_coverfunc("build/gallery-sm-menu/gallery-sm-menu.js", "(anonymous 7)", 1054);
...
item.open();
    ...
    **/
    _onItemMouseLeave: function (e) {
        _yuitest_coverfunc("build/gallery-sm-menu/gallery-sm-menu.js", "_onItemMouseLeave", 1066);
...
return;
        ...
        _yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1075);
this._timeouts.item = setTimeout(function () {
            _yuitest_coverfunc("build/gallery-sm-menu/gallery-sm-menu.js", "(anonymous 8)", 1075);
...
item.close();
    ...
    **/
    _onMenuMouseEnter: function () {
        _yuitest_coverfunc("build/gallery-sm-menu/gallery-sm-menu.js", "_onMenuMouseEnter", 1087);
...
clearTimeout(this._timeouts.menu);
    ...
    **/
    _onMenuMouseLeave: function () {
        _yuitest_coverfunc("build/gallery-sm-menu/gallery-sm-menu.js", "_onMenuMouseLeave", 1098);
_yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1099);
var self = this;

        _yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1101);
clearTimeout(this._timeouts.menu);

        _yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1103);
this._timeouts.menu = setTimeout(function () {
            _yuitest_coverfunc("build/gallery-sm-menu/gallery-sm-menu.js", "(anonymous 9)", 1103);
_yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1104);
self.closeSubMenus();

            _yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1106);
if (self.get('hideOnMouseLeave')) {
                _yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1107);
self.hide();
            }
        }, 500);
    },
    ...
    **/
    _defItemClickFn: function (e) {
        _yuitest_coverfunc("build/gallery-sm-menu/gallery-sm-menu.js", "_defItemClickFn", 1121);
_yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1122);
var item = e.item;

        _yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1124);
if (item.canHaveChildren) {
...
clearTimeout(this._timeouts.menu);
            ...
            _yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1128);
e.item.toggle();
        } else {_yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1129);
if (this.get('hideOnClick')) {
            _yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1130);
this.closeSubMenus();
...
this.hide();
    ...
    **/
    _defSpecificItemClickFn: function (e) {
        _yuitest_coverfunc("build/gallery-sm-menu/gallery-sm-menu.js", "_defSpecificItemClickFn", 1142);
_yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1143);
this.fire(EVT_ITEM_CLICK, {
    ...
    ATTRS: {
        ...
        **/
        alignments: {
            valueFn: function () {
                _yuitest_coverfunc("build/gallery-sm-menu/gallery-sm-menu.js", "valueFn", 1179);
...
return ['tl-bl', 'tr-br', 'bl-tl', 'br-tr'];
        ...
        **/
        subMenuAlignments: {
            valueFn: function () {
                _yuitest_coverfunc("build/gallery-sm-menu/gallery-sm-menu.js", "valueFn", 1235);
_yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1236);
...
_yuitest_coverline("build/gallery-sm-menu/gallery-sm-menu.js", 1253);
