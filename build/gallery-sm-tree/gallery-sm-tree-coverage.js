...
var Tree = Y.Base.create('tree', Y.Base, [], {
    ...
    **/
    ...
    initializer: function (config) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "initializer", 159);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 160);
config || (config = {});
...
this.nodeClass = Y.Object.getValue(Y, this.nodeClass.split('.'));
            ...
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 177);
if (!this.nodeClass) {
...
Y.error('Tree: Node class not found: ' + this.nodeClass);
        ...
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 182);
...
this.appendNode(this.rootNode, config.nodes, {silent: true});
    ...
    destructor: function () {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "destructor", 190);
...
delete this._nodeMap;
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 197);
delete this._published;
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 198);
delete this._selectedMap;
    ...
    **/
    appendNode: function (parent, node, options) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "appendNode", 222);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 223);
return this.insertNode(parent, node, Y.merge(options, {
    ...
    **/
    clear: function (rootNode, options) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "clear", 242);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 243);
return this._fire(EVT_CLEAR, {
    ...
    **/
    closeNode: function (node, options) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "closeNode", 260);
...
this._fire(EVT_CLOSE, {node: node}, {
        ...
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 268);
return this;
    },
    ...
    **/
    createNode: function (config) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "createNode", 282);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 283);
config || (config = {});

        // If `config` is already a node, just ensure it's in the node map and
        // return it.
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 287);
if (config._isYUITreeNode) {
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 288);
this._adoptNode(config);
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 289);
return config;
        }

        // First, create nodes for any children of this node.
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 293);
if (config.children) {
...
return this._nodeMap[node.id] = node;
    ...
    **/
    destroyNode: function (node, options) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "destroyNode", 319);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 320);
var child, i, len;

        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 322);
options || (options = {});

        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 324);
for (i = 0, len = node.children.length; i < len; i++) {
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 325);
...
if (node.parent) {
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 337);
...
delete node.data;
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 342);
delete node.state;
...
delete node._htmlNode;
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 345);
delete node._indexMap;

        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 347);
delete this._nodeMap[node.id];

        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 349);
...
return this;
    ...
    **/
    emptyNode: function (node, options) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "emptyNode", 368);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 369);
var removed = [];

        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 371);
while (node.children.length) {
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 372);
removed.push(this.removeNode(node.children[0], options));
        }

        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 375);
return removed;
    },
    ...
    **/
    getNodeById: function (id) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "getNodeById", 386);
...
return this._nodeMap[id];
    ...
    **/
    getSelectedNodes: function () {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "getSelectedNodes", 396);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 397);
return Y.Object.values(this._selectedMap);
    ...
    **/
    insertNode: function (parent, node, options) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "insertNode", 423);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 424);
options || (options = {});
...
var index = options.index;
        ...
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 429);
if (typeof index === 'undefined') {
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 430);
...
if (Lang.isArray(node)) {
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 435);
var inserted = [];

            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 437);
node = node.concat(); // avoid modifying the passed array

            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 439);
for (var i = 0, len = node.length; i < len; i++) {
                _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 440);
inserted.push(this.insertNode(parent, node[i], options));

                _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 442);
if ('index' in options) {
...
node = this.createNode(node);
        ...
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 452);
this._fire(EVT_ADD, {
            index : index,
            node  : node,
            parent: parent,
        ...
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 462);
return node;
    },
    ...
    **/
    openNode: function (node, options) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "openNode", 474);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 475);
if (node.canHaveChildren && !node.isOpen()) {
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 476);
...
return this;
    ...
    **/
    prependNode: function (parent, node, options) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "prependNode", 504);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 505);
return this.insertNode(parent, node, Y.merge(options, {
            index: 0,
            src  : 'prepend'
        }));
    ...
    **/
    removeNode: function (node, options) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "removeNode", 525);
...
this._fire(EVT_REMOVE, {
        ...
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 538);
return node;
    },
    ...
    **/
    selectNode: function (node, options) {
        ...
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "selectNode", 551);
...
this._fire(EVT_SELECT, {node: node}, {
        ...
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 563);
return this;
    },
    ...
    **/
    size: function () {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "size", 574);
...
return this.rootNode.size();
    ...
    **/
    toggleNode: function (node, options) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "toggleNode", 588);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 589);
return node.isOpen() ? this.closeNode(node, options) :
    ...
    **/
    toJSON: function () {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "toJSON", 599);
...
return this.rootNode.toJSON();
    ...
    **/
    unselect: function (options) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "unselect", 612);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 613);
for (var id in this._selectedMap) {
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 614);
if (this._selectedMap.hasOwnProperty(id)) {
                _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 615);
...
return this;
    ...
    **/
    unselectNode: function (node, options) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "unselectNode", 632);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 633);
if (node.isSelected() || this._selectedMap[node.id]) {
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 634);
...
return this;
    ...
    **/
    _adoptNode: function (node, options) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "_adoptNode", 654);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 655);
var oldTree = node.tree;

        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 657);
if (oldTree === this) {
...
this._adoptNode(node.children[i], {silent: true});
        ...
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 665);
...
delete oldTree._nodeMap[node.id];
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 669);
...
node.tree = this;
    ...
    _attachTreeEvents: function () {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "_attachTreeEvents", 673);
...
this._treeEvents.push(
    ...
    _detachTreeEvents: function () {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "_detachTreeEvents", 681);
...
this._treeEvents = [];
    ...
    **/
    _fire: function (name, facade, options) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "_fire", 699);
...
options.defaultFn.call(this, facade);
            ...
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 705);
...
this._published[name] = this.publish(name, {
            ...
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 711);
this.fire(name, facade);
        }

        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 714);
return this;
    },
    ...
    **/
    _removeNodeFromParent: function (node) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "_removeNodeFromParent", 724);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 725);
var parent = node.parent,
            index;

        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 728);
if (parent) {
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 729);
index = parent.indexOf(node);

            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 731);
if (index > -1) {
...
parent._isIndexStale = true;
                _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 734);
delete node.parent;
            }
        }
    },
    ...
    _afterMultiSelectChange: function (e) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "_afterMultiSelectChange", 740);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 741);
...
this.unselect();
    ...
    _defAddFn: function (e) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "_defAddFn", 746);
...
this._removeNodeFromParent(node);
        ...
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 754);
node.parent = parent;
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 755);
...
parent.canHaveChildren = true;
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 758);
parent._isIndexStale   = true;

        // If the node is marked as selected, we need go through the select
        // flow.
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 762);
if (node.isSelected()) {
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 763);
this.selectNode(node);
        }
    },

    _defClearFn: function (e) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "_defClearFn", 767);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 768);
var newRootNode = e.rootNode;

        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 770);
if (this.rootNode) {
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 771);
this.destroyNode(this.rootNode, {silent: true});
        }
...
this._nodeMap[newRootNode.id] = newRootNode;
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 778);
this.rootNode = newRootNode;
    },

    _defCloseFn: function (e) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "_defCloseFn", 781);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 782);
delete e.node.state.open;
    },

    _defOpenFn: function (e) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "_defOpenFn", 785);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 786);
e.node.state.open = true;
    },

    _defRemoveFn: function (e) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "_defRemoveFn", 789);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 790);
var node = e.node;
...
this.destroyNode(node, {silent: true});
        } else {_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 797);
if (e.parent) {
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 798);
this._removeNodeFromParent(node);
        } else {_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 799);
...
this.rootNode = this.createNode(this._rootNodeConfig);
    ...
    _defSelectFn: function (e) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "_defSelectFn", 805);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 806);
if (!this.get('multiSelect')) {
            _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 807);
this.unselect();
        }

        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 810);
...
this._selectedMap[e.node.id] = e.node;
    ...
    _defUnselectFn: function (e) {
        _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "_defUnselectFn", 814);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 815);
delete e.node.state.selected;
        _yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 816);
delete this._selectedMap[e.node.id];
    ...
    ATTRS: {
        ...
        **/
        rootNode: {
            getter: function () {
                _yuitest_coverfunc("build/gallery-sm-tree/gallery-sm-tree.js", "getter", 837);
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 838);
...
_yuitest_coverline("build/gallery-sm-tree/gallery-sm-tree.js", 846);
