...
_yuitest_coverage["build/gallery-sm-tree-node/gallery-sm-tree-node.js"].functions = {"TreeNode:43":0,"append:203":0,"close:218":0,"empty:236":0,"hasChildren:247":0,"index:259":0,"indexOf:272":0,"insert:306":0,"isInTree:318":0,"isOpen:332":0,"isRoot:343":0,"isSelected:354":0,"open:367":0,"prepend:388":0,"remove:404":0,"select:417":0,"size:430":0,"toggle:451":0,"toJSON:462":0,"unselect:513":0,"_reindex:519":0,"(anonymous 1):1":0};
_yuitest_coverage["build/gallery-sm-tree-node/gallery-sm-tree-node.js"].coveredLines = 72;
_yuitest_coverage["build/gallery-sm-tree-node/gallery-sm-tree-node.js"].coveredFunctions = 22;
...
return this.tree.appendNode(this, node, options);
    ...
    **/
    close: function (options) {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "close", 218);
_yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 219);
this.tree.closeNode(this, options);
        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 220);
return this;
    },
    ...
    **/
    empty: function (options) {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "empty", 236);
_yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 237);
return this.tree.emptyNode(this, options);
    ...
    **/
    hasChildren: function () {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "hasChildren", 247);
_yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 248);
return !!this.children.length;
    ...
    **/
    index: function () {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "index", 259);
_yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 260);
return this.parent ? this.parent.indexOf(this) : -1;
    ...
    **/
    indexOf: function (node) {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "indexOf", 272);
_yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 273);
var index;

        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 275);
if (this._isIndexStale) {
            _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 276);
this._reindex();
        }

        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 279);
index = this._indexMap[node.id];

        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 281);
return typeof index === 'undefined' ? -1 : index;
    ...
    **/
    insert: function (node, options) {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "insert", 306);
_yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 307);
return this.tree.insertNode(this, node, options);
    ...
    **/
    isInTree: function () {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "isInTree", 318);
...
return true;
        ...
        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 323);
return !!(this.parent && this.parent.isInTree());
    ...
    **/
    isOpen: function () {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "isOpen", 332);
_yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 333);
return !!this.state.open || this.isRoot();
    ...
    **/
    isRoot: function () {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "isRoot", 343);
...
return this.tree.rootNode === this;
    ...
    **/
    isSelected: function () {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "isSelected", 354);
_yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 355);
return !!this.state.selected;
    ...
    **/
    open: function (options) {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "open", 367);
_yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 368);
this.tree.openNode(this, options);
        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 369);
return this;
    },
    ...
    **/
    prepend: function (node, options) {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "prepend", 388);
_yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 389);
return this.tree.prependNode(this, node, options);
    ...
    **/
    remove: function (options) {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "remove", 404);
...
return this.tree.removeNode(this, options);
    ...
    **/
    select: function (options) {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "select", 417);
_yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 418);
this.tree.selectNode(this, options);
        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 419);
return this;
    },
    ...
    **/
    size: function () {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "size", 430);
...
for (var i = 0; i < len; i++) {
            _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 436);
total += children[i].size();
        }

        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 439);
return total;
    },
    ...
    **/
    toggle: function (options) {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "toggle", 451);
_yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 452);
this.tree.toggleNode(this, options);
        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 453);
return this;
    },
    ...
    **/
    toJSON: function () {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "toJSON", 462);
_yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 463);
var obj   = {},
            state = this.state,
            i, key, len;

        // Do nothing if this node is marked as destroyed.
        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 468);
if (state.destroyed) {
...
key = this._serializable[i];
            ...
            _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 476);
if (key in this) {
...
obj.state = {};
        ...
        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 484);
if (state.open) {
            _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 485);
obj.state.open = true;
        }

        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 488);
if (state.selected) {
            _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 489);
obj.state.selected = true;
        }

        // Serialize child nodes.
        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 493);
if (this.canHaveChildren) {
            _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 494);
obj.children = [];

            _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 496);
for (i = 0, len = this.children.length; i < len; i++) {
                _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 497);
obj.children.push(this.children[i].toJSON());
            }
        }

        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 501);
return obj;
    },
    ...
    **/
    unselect: function (options) {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "unselect", 513);
_yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 514);
this.tree.unselectNode(this, options);
        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 515);
return this;
    },

    // -- Protected Methods ----------------------------------------------------
    _reindex: function () {
        _yuitest_coverfunc("build/gallery-sm-tree-node/gallery-sm-tree-node.js", "_reindex", 519);
_yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 520);
var children = this.children,
            indexMap = {},
            i, len;

        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 524);
for (i = 0, len = children.length; i < len; i++) {
            _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 525);
indexMap[children[i].id] = i;
        }

        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 528);
this._indexMap     = indexMap;
        _yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 529);
this._isIndexStale = false;
    }
};

_yuitest_coverline("build/gallery-sm-tree-node/gallery-sm-tree-node.js", 533);
