...
_yuitest_coverage["build/gallery-sm-treeview/gallery-sm-treeview.js"].lines = {"1":0,"19":0,"90":0,"94":0,"109":0,"110":0,"113":0,"126":0,"129":0,"130":0,"132":0,"136":0,"137":0,"140":0,"142":0,"160":0,"162":0,"166":0,"167":0,"174":0,"175":0,"176":0,"178":0,"181":0,"182":0,"184":0,"185":0,"187":0,"197":0,"199":0,"200":0,"203":0,"221":0,"223":0,"227":0,"228":0,"235":0,"238":0,"240":0,"241":0,"242":0,"245":0,"246":0,"248":0,"249":0,"250":0,"252":0,"253":0,"258":0,"260":0,"261":0,"264":0,"270":0,"272":0,"275":0,"297":0,"310":0,"317":0,"318":0,"321":0,"325":0,"326":0,"328":0,"329":0,"331":0,"334":0,"336":0,"340":0,"344":0,"351":0,"352":0,"355":0,"356":0,"358":0,"359":0,"363":0,"364":0,"367":0,"369":0,"370":0,"374":0,"375":0,"378":0,"382":0,"383":0,"388":0,"389":0,"393":0,"394":0,"397":0,"399":0,"400":0,"401":0,"406":0,"407":0,"410":0,"412":0,"414":0,"417":0,"419":0,"424":0,"425":0,"428":0,"432":0,"433":0,"434":0,"438":0,"439":0,"444":0,"445":0,"448":0,"450":0,"452":0,"453":0,"456":0,"460":0,"464":0,"466":0,"472":0,"476":0,"478":0,"479":0,"481":0,"486":0,"509":0};
_yuitest_coverage["build/gallery-sm-treeview/gallery-sm-treeview.js"].functions = {"initializer:89":0,"destructor:93":0,"getHTMLNode:108":0,"render:125":0,"renderChildren:159":0,"renderNode:220":0,"_attachTreeViewEvents:269":0,"_detachTreeViewEvents:296":0,"_setLazyRender:309":0,"_afterAdd:315":0,"_afterClear:349":0,"_afterClose:362":0,"_afterOpen:373":0,"_afterRemove:392":0,"_afterSelect:405":0,"_afterTreeViewMultiSelectChange:423":0,"_afterUnselect:443":0,"_onIndicatorClick:459":0,"_onMouseDown:469":0,"_onRowClick:475":0,"_onRowDoubleClick:485":0,"(anonymous 1):1":0};
_yuitest_coverage["build/gallery-sm-treeview/gallery-sm-treeview.js"].coveredLines = 125;
...
TreeView = Y.Base.create('treeView', Y.View, [Y.Tree], {
    ...
    **/
    ...
    initializer: function () {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "initializer", 89);
_yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 90);
this._attachTreeViewEvents();
    },

    destructor: function () {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "destructor", 93);
...
this._detachTreeViewEvents();
    ...
    **/
    getHTMLNode: function (treeNode) {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "getHTMLNode", 108);
_yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 109);
...
return treeNode._htmlNode;
    ...
    **/
    render: function () {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "render", 125);
...
if (!container.inDoc()) {
            _yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 137);
...
return this;
    ...
    **/
    renderChildren: function (treeNode, options) {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "renderChildren", 159);
...
if (!childrenNode) {
            _yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 167);
childrenNode = Y.Node.create(TreeView.Templates.children({
        ...
        _yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 174);
if (treeNode.isRoot()) {
            _yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 175);
...
for (var i = 0, len = treeNode.children.length; i < len; i++) {
                _yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 185);
...
container.append(childrenNode);
        ...
        _yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 203);
return childrenNode;
    },
    ...
    **/
    renderNode: function (treeNode, options) {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "renderNode", 220);
_yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 221);
options || (options = {});

        _yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 223);
...
return htmlNode;
    ...
    _attachTreeViewEvents: function () {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "_attachTreeViewEvents", 269);
_yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 270);
this._treeViewEvents || (this._treeViewEvents = []);

        _yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 272);
var classNames = this.classNames,
...
this._treeViewEvents.push(
    ...
    _detachTreeViewEvents: function () {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "_detachTreeViewEvents", 296);
_yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 297);
(new Y.EventHandle(this._treeViewEvents)).detach();
    ...
    **/
    _setLazyRender: function (value) {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "_setLazyRender", 309);
_yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 310);
return this._lazyRender = value;
    ...
    _afterAdd: function (e) {
        ...
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "_afterAdd", 315);
_yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 317);
if (!this.rendered) {
            _yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 318);
return;
        }

        _yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 321);
var parent = e.parent,
            htmlChildrenNode,
            htmlNode;
...
htmlNode         = this.getHTMLNode(parent);
            _yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 329);
...
htmlChildrenNode.insert(this.renderNode(e.node, {
    ...
    _afterClear: function () {
        // Nothing to do if the treeview hasn't been rendered yet.
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "_afterClear", 349);
...
this.render();
    ...
    _afterClose: function (e) {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "_afterClose", 362);
...
htmlNode.set('aria-expanded', false);
    ...
    _afterOpen: function (e) {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "_afterOpen", 373);
...
htmlNode.set('aria-expanded', true);
    ...
    _afterRemove: function (e) {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "_afterRemove", 392);
...
delete e.node._htmlNode;
    ...
    _afterSelect: function (e) {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "_afterSelect", 405);
...
htmlNode.set('tabIndex', 0).focus();
    ...
    _afterTreeViewMultiSelectChange: function (e) {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "_afterTreeViewMultiSelectChange", 423);
...
return;
        ...
        _yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 428);
var container = this.get('container'),
...
htmlNodes.removeAttribute('aria-selected');
    ...
    _afterUnselect: function (e) {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "_afterUnselect", 443);
...
htmlNode.removeAttribute('tabIndex');
    ...
    _onIndicatorClick: function (e) {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "_onIndicatorClick", 459);
...
this.getNodeById(rowNode.getData('node-id')).toggle();
    ...
    _onMouseDown: function (e) {
        ...
        // is set on a node.
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "_onMouseDown", 469);
_yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 472);
e.preventDefault();
    },

    _onRowClick: function (e) {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "_onRowClick", 475);
...
node.select();
    ...
    _onRowDoubleClick: function (e) {
        _yuitest_coverfunc("build/gallery-sm-treeview/gallery-sm-treeview.js", "_onRowDoubleClick", 485);
...
_yuitest_coverline("build/gallery-sm-treeview/gallery-sm-treeview.js", 509);
