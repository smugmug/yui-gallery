...
_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 72);
var EVT_ERROR = 'error';
...
**/
_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 80);
...
**/
_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 93);
var EVT_LOADING = 'loading';

_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 95);
Y.namespace('Plugin.Tree').Lazy = Y.Base.create('lazyTreePlugin', Y.Plugin.Base, [], {
    // -- Lifecycle Methods ----------------------------------------------------
    initializer: function (config) {
        _yuitest_coverfunc("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", "initializer", 97);
_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 98);
this._host = config.host;

        _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 100);
if (config.load) {
            _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 101);
this.load = config.load;
        }
...
this._attachEvents();
    ...
    // -- Public Methods -------------------------------------------------------
    load: function (node, callback) {
        _yuitest_coverfunc("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", "load", 109);
...
callback(new Error('Plugin.Tree.Lazy: Please provide a custom `load` method when instantiating this plugin.'));
    ...
    _attachEvents: function () {
        _yuitest_coverfunc("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", "_attachEvents", 115);
_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 116);
this.onHostEvent('open', this._onOpen);
    ...
    _onOpen: function (e) {
        _yuitest_coverfunc("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", "_onOpen", 121);
_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 122);
var node = e.node;

        // Nothing to do if this node can't have children or if its children
        // have already been (or are already being) loaded.
        _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 126);
if (!node.canHaveChildren || node.state.loaded || node.state.loading) {
            _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 127);
return;
        }

        _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 130);
if (!this._published[EVT_LOADING]) {
            _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 131);
this._published[EVT_LOADING] = this.publish(EVT_LOADING, {
                defaultFn: this._defLoadingFn
            });
        }

        _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 136);
this.fire(EVT_LOADING, {node: node});
    ...
    _defLoadingFn: function (e) {
        _yuitest_coverfunc("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", "_defLoadingFn", 141);
_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 142);
var node = e.node,
            self = this;

        _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 145);
node.state.loading = true;

        _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 147);
this.load(node, function (err) {
            _yuitest_coverfunc("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", "(anonymous 2)", 147);
_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 148);
delete node.state.loading;

            _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 150);
if (err) {
...
return;
            ...
            _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 159);
node.state.loaded = true;

            _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 161);
