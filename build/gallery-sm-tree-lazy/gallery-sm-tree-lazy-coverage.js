...
_yuitest_coverage["build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
**/
_yuitest_coverfunc("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", "(anonymous 1)", 1);
_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 76);
var EVT_ERROR = 'error';
...
**/
_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 84);
...
**/
_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 97);
var EVT_LOADING = 'loading';

_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 99);
Y.namespace('Plugin.Tree').Lazy = Y.Base.create('lazyTreePlugin', Y.Plugin.Base, [], {
    // -- Lifecycle Methods ----------------------------------------------------
    initializer: function (config) {
        _yuitest_coverfunc("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", "initializer", 101);
_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 102);
this._host = config.host;

        _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 104);
if (config.load) {
            _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 105);
this.load = config.load;
        }

        // Make sure we've been plugged into a Tree that mixes in the
        // Tree.Openable extension.
        _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 110);
if (!this._host.openNode) {
        }

        _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 113);
this._published = {};
        _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 114);
this._attachEvents();
    },

    // -- Public Methods -------------------------------------------------------
    load: function (node, callback) {
        _yuitest_coverfunc("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", "load", 118);
_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 119);
callback(new Error('Plugin.Tree.Lazy: Please provide a custom `load` method when instantiating this plugin.'));
    },

    // -- Protected Methods ----------------------------------------------------
    _attachEvents: function () {
        _yuitest_coverfunc("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", "_attachEvents", 123);
_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 124);
this.onHostEvent('open', this._onOpen);
    },

    // -- Protected Event Handlers ---------------------------------------------
    _onOpen: function (e) {
        _yuitest_coverfunc("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", "_onOpen", 128);
_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 129);
var node = e.node;

        // Nothing to do if this node can't have children or if its children
        // have already been (or are already being) loaded.
        _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 133);
if (!node.canHaveChildren || node.state.loaded || node.state.loading) {
            _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 134);
return;
        }

        _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 137);
if (!this._published[EVT_LOADING]) {
            _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 138);
this._published[EVT_LOADING] = this.publish(EVT_LOADING, {
                defaultFn: this._defLoadingFn
            });
        }

        _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 143);
this.fire(EVT_LOADING, {node: node});
    },

    // -- Default Event Handlers -----------------------------------------------
    _defLoadingFn: function (e) {
        _yuitest_coverfunc("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", "_defLoadingFn", 147);
_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 148);
var node = e.node,
            self = this;

        _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 151);
node.state.loading = true;

        _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 153);
this.load(node, function (err) {
            _yuitest_coverfunc("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", "(anonymous 2)", 153);
_yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 154);
delete node.state.loading;

            _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 156);
if (err) {
                _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 157);
self.fire(EVT_ERROR, {
                    error: err,
                    src  : 'load'
                });

                _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 162);
return;
            }

            _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 165);
node.state.loaded = true;

            _yuitest_coverline("build/gallery-sm-tree-lazy/gallery-sm-tree-lazy.js", 167);
...
}, '@VERSION@', {"requires": ["base-pluginhost", "plugin", "gallery-sm-tree"]});
