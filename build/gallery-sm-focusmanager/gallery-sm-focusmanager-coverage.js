...
if (this.preventDefaultMap[key]) {
                _yuitest_coverline("build/gallery-sm-focusmanager/gallery-sm-focusmanager.js", 527);
e.preventDefault();
            }

            _yuitest_coverline("build/gallery-sm-focusmanager/gallery-sm-focusmanager.js", 530);
if (typeof action === 'string') {
                _yuitest_coverline("build/gallery-sm-focusmanager/gallery-sm-focusmanager.js", 531);
this[action].call(this);
            } else {
                _yuitest_coverline("build/gallery-sm-focusmanager/gallery-sm-focusmanager.js", 533);
action.call(this);
            }
        }
    }
        ...
        **/
        activeItem: {
            valueFn: function () {
                ...
                _yuitest_coverfunc("build/gallery-sm-focusmanager/gallery-sm-focusmanager.js", "valueFn", 549);
_yuitest_coverline("build/gallery-sm-focusmanager/gallery-sm-focusmanager.js", 553);
return this.first();
            }
        },
...
_yuitest_coverline("build/gallery-sm-focusmanager/gallery-sm-focusmanager.js", 693);
