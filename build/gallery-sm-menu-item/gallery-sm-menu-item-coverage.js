...
_yuitest_coverline("build/gallery-sm-menu-item/gallery-sm-menu-item.js", 36);
function MenuItem(menu, config) {
    _yuitest_coverfunc("build/gallery-sm-menu-item/gallery-sm-menu-item.js", "MenuItem", 36);
_yuitest_coverline("build/gallery-sm-menu-item/gallery-sm-menu-item.js", 37);
config || (config = {});

    _yuitest_coverline("build/gallery-sm-menu-item/gallery-sm-menu-item.js", 39);
this.id   = this._yuid = config.id || Y.guid('menuItem-');
    _yuitest_coverline("build/gallery-sm-menu-item/gallery-sm-menu-item.js", 40);
...
_yuitest_coverline("build/gallery-sm-menu-item/gallery-sm-menu-item.js", 46);
Y.extend(MenuItem, Y.Tree.Node, {
    ...
    **/
    disable: function (options) {
        _yuitest_coverfunc("build/gallery-sm-menu-item/gallery-sm-menu-item.js", "disable", 58);
_yuitest_coverline("build/gallery-sm-menu-item/gallery-sm-menu-item.js", 59);
this.tree.disableItem(this, options);
        _yuitest_coverline("build/gallery-sm-menu-item/gallery-sm-menu-item.js", 60);
return this;
    },
    ...
    **/
    enable: function (options) {
        _yuitest_coverfunc("build/gallery-sm-menu-item/gallery-sm-menu-item.js", "enable", 72);
_yuitest_coverline("build/gallery-sm-menu-item/gallery-sm-menu-item.js", 73);
this.tree.enableItem(this, options);
        _yuitest_coverline("build/gallery-sm-menu-item/gallery-sm-menu-item.js", 74);
return this;
    },
    ...
    **/
    hide: function (options) {
        _yuitest_coverfunc("build/gallery-sm-menu-item/gallery-sm-menu-item.js", "hide", 86);
_yuitest_coverline("build/gallery-sm-menu-item/gallery-sm-menu-item.js", 87);
this.tree.hideItem(this, options);
        _yuitest_coverline("build/gallery-sm-menu-item/gallery-sm-menu-item.js", 88);
return this;
    },
    ...
    **/
    isDisabled: function () {
        _yuitest_coverfunc("build/gallery-sm-menu-item/gallery-sm-menu-item.js", "isDisabled", 98);
_yuitest_coverline("build/gallery-sm-menu-item/gallery-sm-menu-item.js", 99);
return !!this.state.disabled;
    ...
    **/
    isHidden: function () {
        _yuitest_coverfunc("build/gallery-sm-menu-item/gallery-sm-menu-item.js", "isHidden", 109);
_yuitest_coverline("build/gallery-sm-menu-item/gallery-sm-menu-item.js", 110);
return !!this.state.hidden;
    ...
    **/
    show: function (options) {
        _yuitest_coverfunc("build/gallery-sm-menu-item/gallery-sm-menu-item.js", "show", 122);
_yuitest_coverline("build/gallery-sm-menu-item/gallery-sm-menu-item.js", 123);
this.tree.showItem(this, options);
        _yuitest_coverline("build/gallery-sm-menu-item/gallery-sm-menu-item.js", 124);
return this;
    }
});

_yuitest_coverline("build/gallery-sm-menu-item/gallery-sm-menu-item.js", 128);
