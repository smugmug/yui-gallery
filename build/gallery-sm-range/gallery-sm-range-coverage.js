...
function traverseDOMNode(domNode) {
            _yuitest_coverfunc("build/gallery-sm-range/gallery-sm-range.js", "traverseDOMNode", 502);
...
traverseDOMNode(domNode.firstChild);
            } else {_yuitest_coverline("build/gallery-sm-range/gallery-sm-range.js", 511);
if (domNode.nextSibling) {
                _yuitest_coverline("build/gallery-sm-range/gallery-sm-range.js", 512);
...
return this;
    ...
    **/
    wrap: isHTML5 ? function (html, options) {
        ...
        _yuitest_coverfunc("build/gallery-sm-range/gallery-sm-range.js", "(anonymous 17)", 540);
_yuitest_coverline("build/gallery-sm-range/gallery-sm-range.js", 550);
var contents  = this._range.extractContents(),
            container = Y.DOM.create(html); // TODO: handle fragments?

        _yuitest_coverline("build/gallery-sm-range/gallery-sm-range.js", 553);
...
this._range.selectNode(container);
            ...
            _yuitest_coverline("build/gallery-sm-range/gallery-sm-range.js", 559);
...
return Y.one(container);
        ...
        _yuitest_coverfunc("build/gallery-sm-range/gallery-sm-range.js", "}", 563);
_yuitest_coverline("build/gallery-sm-range/gallery-sm-range.js", 564);
throw new Error('Not yet implemented.');
    }
};
